...
$(document).ready(function () {
  ...
  $("#page").append('<iframe src="https://drive.google.com/file/d/1op0AqEZJKkcV1gJDRQ5wgRqZvggQwcPU/preview" width="1200" height="600"></iframe>');
  $("#page").append("</div>");
  $("#page").append('<a href="https://drive.google.com/uc?export=download&id=1op0AqEZJKkcV1gJDRQ5wgRqZvggQwcPU" target="_blank">Download</a>');
