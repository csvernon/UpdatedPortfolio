...
$(document).ready(function () {
  ...
  $("#page").append('<iframe src="https://drive.google.com/file/d/1rLrRj_Gs6-Pyr-U19L68zA1DfphRSWYx/preview" width="1200" height="600"></iframe>');
  $("#page").append("</div>");
  $("#page").append('<a href="https://drive.google.com/uc?export=download&id=1rLrRj_Gs6-Pyr-U19L68zA1DfphRSWYx" target="_blank">Download</a>');
